...
public final class PageElement {
	...
	public static GuiElement ofPrevious(EnchantmentToggleUi ui) {
	...
	public static GuiElement ofNext(EnchantmentToggleUi ui) {
	...
	private static GuiElement of(EnchantmentToggleUi ui, String type, int offset, int shiftPage, String texture) {
	...
	private static ClickCallback createCallback(EnchantmentToggleUi ui, int offset, int shiftPage) {
